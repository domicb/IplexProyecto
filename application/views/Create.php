...
<input type="hidden" name="hosted_button_id" value="Z7EAJXJ684A7G">
<input type="image" src="https://www.paypalobjects.com/es_ES/ES/i/btn/btn_buynow_LG.gif" border="0" name="submit" alt="PayPal, la forma más segura y rápida de pagar en línea.">
